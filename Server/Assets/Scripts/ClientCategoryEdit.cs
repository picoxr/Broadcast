...
public class ClientCategoryEdit : MonoBehaviour {
    ...
    void OnEnable() {
        ...
        mCategories = DataManager.Instance.ClientCategories;
        mInput.text = "";
    ...
    {
        bool inUse = DataManager.Instance.ClientCategoryInUse(mCategories[id]);
        if (!inUse)
        {
    ...
    {
        DataManager.Instance.UpdateCategories(DataType.client,mCategories);
    ...
    public void OnAddClick()
    {
        ...
        {
            string newId = DataManager.Instance.GetNewCategoryId(DataType.client);
