...
public class PicCategoryEdit : MonoBehaviour
{
    ...
    void OnEnable()
    {
        mCategories = DataManager.Instance.PictureCategories;
        mInput.text = "";
    ...
    {
        bool inUse = DataManager.Instance.PictureCategoryInUse(mCategories[id]);
        if (!inUse)
        {
    ...
    {
        DataManager.Instance.UpdateCategories(DataType.picture, mCategories);
    ...
    public void OnAddClick()
    {
        ...
        {
            string newId = DataManager.Instance.GetNewCategoryId(DataType.picture);
